...
ESTADOS_DISPONIBILIDAD_REPUESTO = {
    "disponible",
    "no_disponible",
...
def _validar_estado(estado: str) -> str:
    ...
    if estado_normalizado not in ESTADOS_DISPONIBILIDAD_REPUESTO:
...
class DisponibilidadRepuesto:
    ...
    @staticmethod
    def crear(consulta_id: str, estado: str) -> "DisponibilidadRepuesto":
